...
public class Client {
    public static void main(String[] args) {
        ...
        content1.addItem(q1);
        content1.addItem(q2);
        CheckItemImpl i1 = new CheckItemImpl("检查项1", 0.4, (byte)1);
        CheckItemImpl i2 = new CheckItemImpl("检查项2", 0.6, (byte)0);
        q1.addItem(i1);
        q1.addItem(i2);
        CheckItemImpl i3 = new CheckItemImpl("检查项3", 0.2, (byte)1);
        CheckItemImpl i4 = new CheckItemImpl("检查项4", 0.4, (byte)1);
        CheckItemImpl i5 = new CheckItemImpl("检查项5", 0.4, (byte)0);
        q2.addItem(i3);
        q2.addItem(i4);
        q2.addItem(i5);
        ...
        CheckItemImpl i7 = new CheckItemImpl("检查项7", 0.7, (byte)1);
        q3.addItem(i6);
        q3.addItem(i7);
        CheckItemImpl i8 = new CheckItemImpl("检查项8", 0.4, (byte)1);
        CheckItemImpl i9 = new CheckItemImpl("检查项9", 0.6, (byte)0);
        q4.addItem(i8);
        q4.addItem(i9);
        root.display((byte)0);
    }
